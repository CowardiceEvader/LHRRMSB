...
//pitch �ٶȻ� PID�����Լ� PID���������������
#define PITCH_SPEED_PID_KP        4200.0f                //2900//3200��20������������ʣ�������ûװ���������ʱ��
#define PITCH_SPEED_PID_KI        5.0f                  //60//20//4200��5.0�������ڽ��ص���̨
...
#define PITCH_ENCODE_RELATIVE_PID_KD 2.0f              //0//1.0�����ˣ�����2.0//2.0
...
#define GIMBAL_CALI_PITCH_SIGN  (-1.0f)
#define GIMBAL_CALI_MIN_MOVE_ANGLE 0.08f
#define GIMBAL_CALI_DIRECTION_CONFIRM_TIME 300
