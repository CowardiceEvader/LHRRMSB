...
#define PITCH_SPEED_PID_KP        4200.0f                //2900//3200与20这组数据最合适，适用于没装发射机构的时候
#define PITCH_SPEED_PID_KI        5.0f                  //60//20//4200与5.0是适用于较重的云台
...
#define PITCH_ENCODE_RELATIVE_PID_KD 2.0f              //0//1.0可以了，试试2.0//2.0
...
typedef struct
{
	...
	const get_data_t *gimbal_assist_ctrl;
